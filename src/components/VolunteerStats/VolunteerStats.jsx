...
const VolunteerStats = () => {
  ...
  return (
    ...
    >
      <div className="bg-green-700 text-white  py-8 px-4 flex flex-col md:flex-row justify-around items-center rounded-lg mt-24 font-1">
        {/* Card 1 */}
        ...
        <div className="w-full md:w-px bg-white h-0.5 md:h-12 my-4 md:my-0 hidden md:block"></div>
        ...
        <div className="w-full md:w-px bg-whiteh-0.5 md:h-12 my-4 md:my-0 hidden md:block"></div>
